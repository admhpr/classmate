  ...
  <div>
    ...
    <section class="container">
      ...
      <div class="columns">
            ...
            <div class="card ques-card">
              ...
              <div class="card-content">
                <div class="content">
                  ...
                  <span>asked by:</span>
                  <a :href="user_href(cmData[0])">@{{ cmData[0].first_name }}{{ cmData[0].last_name }}</a>. In
                  <a href="#">#{{cmData[0].category}}</a>.
                  <br>
        ...
        <div class="column is-5 ans-card animated bounceInRight">
          ...
          <aside class="menu">
            ...
            <message :cm-style="dangerMessage" v-if="message.show" @close="message.show = false">
              ...
              You are about to delete something which cannot be recovered is that what you want?
              <br>
              <br>
    ...
    computed: {
      filteredList() {
        if (this.cmData[0].answer_content && this.cmData.length > 1) {
          ...
          cmData = {
            answer_content: "Looks like there no answers for this one can you help out?",
            first_name: "none one"
          };
          return [cmData];
        }
