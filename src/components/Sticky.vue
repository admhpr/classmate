        ...
        <div>
            <div v-show="showInner" class="vue-sticker__inner" :style="stylesInner">
                <div :style="backPicture">
                    <div class="sticker__overflow" :style="innerImageOverflow">
                        <div class="vue-sticker__inner" :class="`${className + prefix}backside-image`" :style="clip">
                        </div>
                    </div>
                </div>
            </div>
            <div :style="mainStyle">
                <div :style="stayWrapper">
                    <div :class="`${className + prefix}main-image`" :style="mainPicture"></div>
                </div>
            </div>
        </div>
    </div>
</template>
//https://github.com/KamilOcean/vue-sticker/blob/master/index.html
<script>
/**
